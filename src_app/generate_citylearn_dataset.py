...
def main():
    ...
    parser.add_argument("--out", type=str, default="data/citylearn_logged.npz")
    ...
    print("=" * 70)
    print("Generating CityLearn Offline Logged Dataset")
    print("=" * 70)
    ...
    for step in range(args.max_steps):
        ...
        segment_terminal = ((step + 1) % args.episode_length == 0)
        terminal = done or segment_terminal
    ...
    print("Number of pseudo-episodes:", len(np.unique(episode_ids)))
